...
MEMORY_MAX_ENTRIES = int(os.getenv("PKF_MEMORY_MAX_ENTRIES", "50"))
BUILD_RESPONSE_MAX_ENTRIES = int(os.getenv("PKF_BUILD_RESPONSE_MAX_ENTRIES", "20"))
BUILD_RESPONSE_MAX_CHARS = int(os.getenv("PKF_BUILD_RESPONSE_MAX_CHARS", "50000"))
